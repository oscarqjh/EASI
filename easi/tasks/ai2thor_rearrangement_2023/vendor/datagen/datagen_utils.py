...
from easi.tasks.ai2thor_rearrangement_2023.vendor.datagen.datagen_constants import OBJECT_TYPES_THAT_CAN_HAVE_IDENTICAL_MESHES
from easi.tasks.ai2thor_rearrangement_2023.vendor.rearrange_constants import OPENNESS_THRESHOLD
